...
/* harmony import */ var _lib_slick_min_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_lib_slick_min_js__WEBPACK_IMPORTED_MODULE_2__);
var _this = undefined;
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slid').slick({
  infinite: true,
  slidesToShow: 3,
  slidesToScroll: 1,
  speed: 100,
...
var data;
fetch('assets/json/cqnrBctj.json').then(function (res) {
  return res.json();
}).then(function (data) {
...
console.log(undefined.data); // let bestSlider = $('.ba-section-slider');
//
// bestSlider.slick({
// 	slide: '.ba-offer',
// 	rows: 0,
...
/* harmony import */ var foundation_sites_js_foundation_slider__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! foundation-sites/js/foundation.slider */ "./node_modules/foundation-sites/js/foundation.slider.js");
...
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_slider__WEBPACK_IMPORTED_MODULE_9__["Slider"], 'Slider');
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_smoothScroll__WEBPACK_IMPORTED_MODULE_10__["SmoothScroll"], 'SmoothScroll'); // Foundation.plugin(Sticky, 'Sticky');
...
module.exports = __webpack_require__(/*! /Users/danil/Documents/test1/src/assets/js/app.js */"./src/assets/js/app.js");
